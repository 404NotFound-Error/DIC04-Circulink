      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="bg-gradient-to-r from-emerald-100/80 to-sky-100/80 rounded-xl p-10 mb-8 shadow-inner border border-emerald-200">
          <div className="flex flex-col items-center justify-center py-10">
            <h2 className="text-6xl md:text-7xl font-extrabold text-emerald-700 tracking-widest drop-shadow-md">DONATION</h2>
        ...
        <div className="mb-8">
          <div className="inline-block bg-emerald-50 border-2 border-emerald-200 rounded-full px-10 py-4 shadow-[0_8px_0_rgba(16,185,129,0.08)]">
            <div className="text-lg md:text-xl font-semibold text-emerald-800">Join DKU's sustainable donation network and make your everyday impact count.</div>
          </div>
        </div>

        <p className="text-emerald-700 text-lg md:text-xl mb-10">Circulink x Buy42 (the Shanghai-based charity store) — Turning idle goods into kindness!</p>
